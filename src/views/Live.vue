  ...
  <div class="flex h-screen bg-gray-900 text-white">
    ...
    <div class="flex-1 flex flex-col justify-between p-4">
      ...
      <div class="relative bg-black rounded-xl flex-1 mb-4 flex justify-center items-center">
        ...
        <div
          class="absolute top-3 right-3 bg-blue-600 px-3 py-1 rounded-full flex items-center space-x-2 text-sm font-semibold"
        >
      ...
      <div class="flex justify-center space-x-4 mb-2">
        ...
        >
          <span>
            ...
            <template v-else>
              <MicrophoneIcon class="w-6 h-6 text-red-600" />
            </template>
          </span>
    ...
    <aside class="w-[20%] bg-gray-800 p-4 flex flex-col space-y-2">
      ...
      <div class="flex space-x-2 mt-2">
        ...
        />
        <button @click="enviarMensaje" class="bg-blue-600 px-4 py-1 rounded-lg">Enviar</button>
      </div>
    </aside>
